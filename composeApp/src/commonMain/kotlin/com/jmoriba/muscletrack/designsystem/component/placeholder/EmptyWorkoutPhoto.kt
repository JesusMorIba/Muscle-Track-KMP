...
import muscletrack.composeapp.generated.resources.ic_empty
import org.jetbrains.compose.resources.painterResource

@Composable
fun EmptyWorkoutPhoto() {
    Box(
        modifier = Modifier
            .fillMaxSize()
            .padding(16.dp),
        ...
        Column(
            ...
            Text("Empty", style = Typography.displaySmall)
            Spacer(modifier = Modifier.height(4.dp))
            Text("You did not exercise on this date", style = Typography.bodyMedium)
        }
    }
}
